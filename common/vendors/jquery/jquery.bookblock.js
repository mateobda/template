	...
	$.BookBlock.prototype = {
      ...
      // Navigation with keywords
		...
		_action : function(dir, page) {
			...
			this._stopSlideshow();
			return this._navigate(dir, page);
		...
		_navigate: function(dir, page) {
			...
			var $pageToNavigate = !this.options.circular && this.end ? this.$current : this.$items.eq(this.current)
			this.$nextItem = $pageToNavigate;
			...
			return {"origin" : "#"+this.$current.attr("id"), "destination" : "#"+$pageToNavigate.attr("id")}
		...
		next: function() {
			return this._action('next');
		},
		// public method: flips back
		//yeah
		prev: function() {
			return this._action('prev');
		},
